...
(function() {
    ...
    // 變更部分
    (function(){
        let o = document.getElementsByClassName("list--links-horizontal");
        let e = document.createElement("p")
        e.id = "filenamer";
        e.textContent = "filename";
        o[o.length-1].appendChild(e);
    })();
    function downloadAndClean() {
        ...
        // 變更部分
        saveAs(new Blob([sentAudio]), document.getElementById("filenamer").textContent + fileExt)
